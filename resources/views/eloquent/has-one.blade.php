...
@section('title')
    <title>Eloquent DataTable with Has One</title>
@endsection
...
@section('content')
    ...
    <div class="tab-content">
        <div class="active tab-pane fade in" id="demo">
            <h2>Eloquent DataTable with Has One</h2>
        ...
        <div class="tab-pane fade" id="php">
            <h2>Routes</h2>
            <pre><code class="php">{{ file_get_contents(base_path('routes/eloquent/has-one.php')) }}</code></pre>

            <h2>Controller</h2>
            <pre><code class="php">{{ file_get_contents(app_path('Http/Controllers/Eloquent/HasOneController.php')) }}</code></pre>
        </div>
